...
Proof.
  intros n m. intros E.   induction E as [|n' E' IH].
...
Theorem ev_ev__ev : forall n m,
  ev (n+m) -> ev n -> ev m.
Proof.
  intros n m. intros E E0.
  induction E0 as [|n' E' IH].
  apply E. apply IH. simpl in E.
...
Proof.
  intros m n o. intros H H0.
  induction H0 as [I1 | I2]. 
  apply H.
  Show Proof.
...
Proof.
  ...
  induction H1. apply le_S. apply le_n.
  inversion H.
...
Proof.
 unfold lt.
 intros n1 n2 m. intros H. 
    apply conj.
  - induction H. 
    apply n_le_m__Sn_le_Sm.
    apply le_plus_l. apply le_S. apply IHle.
  - induction H.
    apply n_le_m__Sn_le_Sm.
    rewrite plus_comm. 
    apply le_plus_l. apply le_S. apply IHle.
...
Lemma MUnion' : forall T (s : list T) (re1 re2 : reg_exp T),
  ...
  s =~ Union re1 re2.
Proof.
  intros T s. intros re1 re2. intros H.
  destruct H.
...
Lemma MStar' : forall T (ss : list (list T)) (re : reg_exp T),
  ...
  fold app ss [] =~ Star re.
Proof.
  intros T ss. intros re. intros H.
  induction ss.
  apply MStar0.
  simpl. apply MStarApp. apply H.
  simpl. intuition. (** yeh, it works**)
  apply IHss.
  intros s. intros H2.
  apply H.
  simpl. intuition.
