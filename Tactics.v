...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = (minustwo o).
Proof.
  intros n m o p. intros H. intros H0.
...
Theorem double_induction: forall (P : nat -> nat -> Prop),
  ...
  forall m n, P m n.
Proof.
    intros P. intros H1 H2 H3 H4. intros m n.
    induction m as [ | m' ].
     - intros. induction n. apply H1. simpl. apply H3. apply IHn.
     - intros. induction n. apply H2. simpl. apply IHm'. apply H4. simpl. simpl.
